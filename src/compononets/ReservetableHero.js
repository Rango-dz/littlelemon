  ...
  return (
    <div className="bg-slate-50 grid md:grid-cols-2 md:p-8 justify-center align-middle ~m-4/8 rounded-3xl">
      <div className="w-full scroll-m-20 grid grid-flow-row gap-2 md:gap-5 lg:gap-7 px-5 lg:px-10 py-8 mx-auto justify-center align-middle place-content-center">
        <h2 className="md:pb-0 ~text-3xl/5xl font-semibold tracking-tight first:mt-0 underline decoration-yellow-300 decoration-2 underline-offset-2 animate-in translate-x-5 transition-all duration-500 ease-in-in">
          Chicago
        </h2>
      ...
      <div className="w-full md:order-1 scroll-m-20 grid grid-flow-row justify-center p-4 py-8">
        <div className="md:block hidden rounded-md  bg-cover">
          <img
            className="bg-cover w-2/3 h-auto object-cover rounded-md align-middle self-center place-content-center text-center"
            src="/table.png"
            alt=""
          />
        </div>
